 ...
 */
public class otherCrawler extends WebCrawler {
...
//    }
    String com="n";
    	hmallouturl.put(href, "ok");
    	if (!(hmallouturl.containsKey(href) && hmallouturl.get(href).equals("OK")))
  	  {
  	  	com = "ok";
  	  }
    
    	for (String domain : crawlDomains) {
      if (!FILTERS.matcher(href).matches() && com.equals("ok") && (href.startsWith("https://clinicaltrials.gov/ct2/show/")||href.startsWith("https://clinicaltrials.gov/ct2/crawl/"))&&!href.startsWith("https://clinicaltrials.gov/ct2/show/study")) {
        return true;
      }
    	}
  ...
  public void visit(Page page) {
   ...
   if (!(url_split[2].contains("clinicaltrials") && (docPatterns.matcher(url).matches()||(page.getParseData() instanceof HtmlParseData)))) {
      return;
    }
  
    int links_size=0;
   
//    	System.out.println("length: : : "+url_split[url_split.length-2]+"/"+url_split[url_split.length-1]);
...
//        System.out.println("html : : "+html);
    ...
    //   System.out.println("Text length: " + text.length());
     ...
     // get a unique name for storing this image
        ...
        String hashedName = url_split[url_split.length-1]+"_"+url_split[url_split.length-2] + ".html";
        ...
        try {
          ...
          FileWriter fileWritter = new FileWriter(storageFolder+"visit.csv",true);
